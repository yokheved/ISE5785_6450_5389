...
public class CameraIntersectionsIntegrationTests {
    ...
    private void testVPs(int VPResolution) throws CloneNotSupportedException{
        ...
        assertNotNull(result3, "TC013: list of points must not be null");
        assertEquals(10, result3.size(), "TC013: size of list should be 10");
        ...
        assertNotNull(result4, "TC014: list of points must not be null");
        assertEquals(9, result4.size(), "TC014: size of list should be 9");
        ...
        assertNull(result5, "TC015: list of points must be null");
        ...
        assertNotNull(result6, "TC021: list of points must not be null");
        assertEquals(9, result6.size(), "TC021: size of list should be 9");
        ...
        assertNotNull(result7, "TC022: list of points must not be null");
        assertEquals(9, result7.size(), "TC022: size of list should be 9");
        ...
        assertNotNull(result8, "TC023: list of points must not be null");
        assertEquals(6, result8.size(), "TC023: size of list should be 6");
        ...
        assertNotNull(result9, "TC031: list of points must not be null");
        assertEquals(1, result9.size(), "TC031: size of list should be 1");

        //TC032: size of 2 px
        Triangle triangle2 = new Triangle(new Point(0, 2, -2),
                new Point(0.5, -0.5, -2), new Point(-0.5, -0.5, -2));
        List<Point> result10 = VPFindIntersections(camera1, triangle2, VPResolution);
        assertNotNull(result10, "TC032: list of points must not be null");
        assertEquals(2, result10.size(), "TC032: size of list should be 2");
