...
class LightsTests {
   ...
   private final Geometry       sphere                  = new Sphere(sphereCenter, SPHERE_RADIUS)
      .setEmission(sphereColor).setMaterial(new Material().setKD(KD).setKS(KS).setShininess(SHININESS));//setShininess
   ...
   @Test
   void sphereDirectional() throws CloneNotSupportedException {
   ...
   @Test
   void spherePoint() throws CloneNotSupportedException {
      scene1.geometries.add(sphere);
   ...
   @Test
   void sphereSpot() throws CloneNotSupportedException {
      scene1.geometries.add(sphere);
   ...
   @Test
   void trianglesDirectional() throws CloneNotSupportedException {
   ...
   @Test
   void trianglesPoint() throws CloneNotSupportedException {
      scene2.geometries.add(triangle1, triangle2);
   ...
   @Test
   void trianglesSpot() throws CloneNotSupportedException {
      scene2.geometries.add(triangle1, triangle2);
   ...
   @Test
   void sphereSpotSharp() throws CloneNotSupportedException {
      scene1.geometries.add(sphere);
      scene1.lights
   ...
   @Test
   void trianglesSpotSharp() throws CloneNotSupportedException {
      scene2.geometries.add(triangle1, triangle2);
      scene2.lights.add(new SpotLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection)
         .setKL(0.001).setKQ(0.00004).setNarrowBeam(10));
