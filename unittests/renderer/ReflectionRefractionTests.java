...
class ReflectionRefractionTests {
   ...
   @Test
   void twoSpheres() throws CloneNotSupportedException {
   ...
   /** Produce a picture of a sphere lighted by a spot light */
   @Test
   void twoSpheresOnMirrors() throws CloneNotSupportedException {
      scene.geometries.add( //
    ...
    */
   @Test
   void trianglesTransparentSphere() throws CloneNotSupportedException {
      scene.geometries.add(
