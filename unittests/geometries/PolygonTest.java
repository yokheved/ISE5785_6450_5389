...
class PolygonTest {
   ...
   void testFindIntersections() {
      ...
      Ray ray1 = new Ray(new Point(2, 2, 2), new Vector(1, 0, 1));
      ...
      assertEquals(new Point(2, 2, 1), result2.get(0), "Wrong intersection point inside the polygon");

      // TC03: Ray intersects the plane but outside against a side
      Ray ray3 = new Ray(new Point(4, 2, 2), new Vector(0, 0, -1));
      ...
      Ray ray4 = new Ray(new Point(4, 4, 2), new Vector(0, 0, -1));
      ...
      Ray ray11 = new Ray(new Point(2, 1, 2), new Vector(0, 0, -1));
      ...
      Ray ray13 = new Ray(new Point(4, 1, 2), new Vector(0, 0, -1));
