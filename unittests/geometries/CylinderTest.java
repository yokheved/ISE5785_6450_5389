...
class CylinderTest {
    ...
    void testFindIntersections() {
        ...
        Ray ray2 = new Ray(new Point(1.5, 1, 2), new Vector(1, 0, 0));
        ...
        Ray ray5 = new Ray(new Point(1.5, 1.5, 0), new Vector(0, 0, 1));
        ...
        Ray ray11 = new Ray(new Point(2, 1, 2), new Vector(0, 1, 0));
        ...
        Ray ray12 = new Ray(new Point(1, 1, 4), new Vector(0, 0, -1));
        ...
        Ray ray13 = new Ray(new Point(3, 1, 1), new Vector(0, 0, 1));
        ...
        Ray ray14 = new Ray(new Point(2, 2, 4), new Vector(0, 0, -1));
