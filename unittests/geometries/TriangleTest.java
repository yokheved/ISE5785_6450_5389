...
class TriangleTest {
    ...
    void testFindIntersections() {
        ...
        Ray ray1 = new Ray(new Point(0, 0, 1), new Vector(0, 1, 0));
        ...
        Ray ray2 = new Ray(new Point(0.25, 0.25, 1), new Vector(0, 0, -1));
        ...
        assertEquals(new Point(0.25, 0.25, 0), result2.get(0),
        ...
        Ray ray13 = new Ray(new Point(1.5, 0, 1), new Vector(0, 0, -1));
